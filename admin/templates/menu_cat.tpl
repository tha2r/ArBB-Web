...
<a href="index.php?action=menu&mid=$cat[mid]" target="_self" onclick="expandcollapse('menu_$cat[mid]');return false;"><img src="cpstyles/cp_$src.gif" title="$langexpcoll" id="button_menu_$cat[mid]" alt="" border="0"></a>
</div>$cat[name]</td>
</tr>
</tbody>
